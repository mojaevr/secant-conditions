...
\addcontentsline{toc}{chapter}{Программная реализация и воспроизводимость}

\section*{Структура репозитория}
\addcontentsline{toc}{section}{Структура репозитория}
...
\section*{Окружение}
\addcontentsline{toc}{section}{Окружение}
...
\end{itemize}
Для воспроизведения PDF достаточно команды
\verb|cd mipt_thesis_master && ./build.sh| (двойной \texttt{pdflatex}).

\section*{Случайные числа и seed'ы}
\addcontentsline{toc}{section}{Случайные числа и seed'ы}
...
\addcontentsline{toc}{section}{Единый критерий остановки}
...
\addcontentsline{toc}{section}{Соответствие между текстом и ноутбуками}
...
Глава~3, табл.~\ref{tab:radius} (скейлинг $R(\alpha,\beta)$) & \texttt{basin.ipynb}, секция <<scaling>> \\
Глава~3, бассейн сходимости (рис.~\ref{fig:basin}) & \texttt{basin.ipynb}, секция <<basin>> \\
