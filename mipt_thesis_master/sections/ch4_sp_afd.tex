...
\emph{условно} относительно дополнительного количественного предположения
Дэнниса--Море (см.~\ref{as:dm-rate} и обсуждение~\ref{rem:dm-rate-status});
это даёт явные константы $C_a, C_b$, зависящие только от $\mu, L_1, \eta, M_0,
c_d, \zeta_{\mathrm{DM}}$. Квадратичный случай $L_1=0$ получается прямой
подстановкой ($\zeta_{\mathrm{DM}}=0$, $C_a=C_b=0$). Безусловный
вариант леммы (без~\ref{as:dm-rate}) остаётся
гипотезой~\ref{conj:alignment} и поддержан численными экспериментами
...
вывод которого зафиксирован как гипотеза~\ref{conj:alignment},~---
...
приложении~\ref{app:alignment} (теорема~\ref{thm:app-aln-l1:main}) условно
при дополнительном предположении Дэнниса--Море~\ref{as:dm-rate};
