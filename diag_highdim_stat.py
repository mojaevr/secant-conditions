...
Задача: Broyden Banded (MGH #31) при n ∈ {10^4, 10^5}.
Цель: показать (i) сходимость limited-memory L-PB при m ∈ {3,5,10,20}
(при n=10^5 берутся {10,20}),
(ii) приближение к плотному Projected Broyden-SM при m ↑ (только n=10^4,
плотный недоступен при n=10^5).

10 случайных стартов: x_0 = broyden_banded_x0(n) + 0.05·u, u — нормированный
standard_normal вектор (u/||u||).
